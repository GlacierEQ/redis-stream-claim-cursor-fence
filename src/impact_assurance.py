"""Executable near/far impact assurance for Stream Claim Cursor Fence."""
from dataclasses import asdict,dataclass
from math import isfinite
from typing import Iterable
REPOSITORY="redis-stream-claim-cursor-fence"; COMPANY_LENS="Redis"; INNOVATION="Stream Claim Cursor Fence"
