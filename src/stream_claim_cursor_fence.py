"""Stream Claim Cursor Fence — SCAFFOLD STUB.

Company lens: Redis (independent; no affiliation).
Bottleneck: Consumers claim stream completeness without cursor/fence semantics under failover.
...
class StreamClaimCursorFence:
    ...
    - `evaluate(req)` returns a StreamClaimCursorFenceReceipt
    ...
    def evaluate(self, req: StreamClaimCursorFenceRequest) -> StreamClaimCursorFenceReceipt:
        ...
        if reasons:
            ...
            return StreamClaimCursorFenceReceipt(
